...
<div class="container">
	...
	<div class="content-center mart-10">
		...
		<form action="./signup_process.php" method="POST">
			...
			<div class="login">
				<img src="./img/login/pwd_grayB6B.png">
				<input type="text" name="pwd_1" placeholder="輸入密碼 ...">
			</div>
			<div class="login">
				<img src="./img/login/pwd_grayB6B.png">
				<input type="text" name="pwd_2" placeholder="再次輸入密碼 ...">
			</div>
			<div class="item">
				<div class="radio-item">
					<label for="general">普通人員</label>
					<input type="radio" id="general" name="authr" value="general">
				</div>
				<div class="radio-item">
					<label for="admin">管理員</label>
					<input type="radio" id="admin" name="authr" value="admin">
				</div>
			</div>
